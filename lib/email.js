...
// Ensure public live domain is ALWAYS used in emails, never localhost
...
Official communications from Emporium Capitals are sent <strong>ONLY</strong> from our verified domain (<strong>@emporiumcapitals.com</strong>). Our staff, administrators, or account managers will <strong>NEVER</strong> contact you via Telegram, WhatsApp, Discord, or social media asking for your account password, 2FA security codes, private wallet keys, or requesting you to transfer funds to personal or unverified crypto addresses.
</p>
<div style="border-top:1px solid rgba(255,255,255,0.08);margin:10px 0;"></div>
<p style="margin:0 0 8px;color:#f59e0b;font-size:12px;font-weight:800;letter-spacing:0.5px;text-transform:uppercase;">
⚠️ Deposit & Withdrawal Policy Disclaimer
</p>
<p style="margin:0;color:rgba(255,255,255,0.8);font-size:11px;line-height:1.6;">
All deposits, payments, and withdrawal requests must be initiated and confirmed solely through your authenticated portal at <a href="${appUrl}" style="color:#ef4d45;text-decoration:underline;">${appUrl.replace(/^https?:\/\//, '')}</a>. Always verify the coin network (e.g., TRC20, ERC20, BTC) before initiating any transfer. Emporium Capitals is not liable for transactions sent to incorrect addresses or unapproved third-party payment rails.
</p>
</td></tr>
</table>
</td></tr>
...
<br>Official Portal: <a href="${appUrl}" style="color:#ef4d45;text-decoration:none;">${appUrl}</a> &nbsp;·&nbsp;
<a href="mailto:support@emporiumcapitals.com" style="color:rgba(255,255,255,0.5);text-decoration:none;">support@emporiumcapitals.com</a>
</p>
</td></tr>
...
export function safeSend(promise) {
    promise.catch(e => logger.error('email send failed (non-blocking)', { message: e?.message, code: e?.code }));
}
